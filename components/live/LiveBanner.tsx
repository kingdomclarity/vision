...
const liveBanners: Banner[] = [
  {
    id: '1',
    imageUrl: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=1600&h=900&fit=crop',
    link: '/live/concert-2024',
    title: 'Live Music Festival 2024',
    subtitle: 'Join us for an incredible night of live performances'
  },
  {
    id: '2',
    imageUrl: 'https://images.unsplash.com/photo-1578022761797-b8636ac1773c?w=1600&h=900&fit=crop',
    link: '/live/championship-boxing',
    title: 'Championship Boxing Night',
    subtitle: 'Watch the heavyweight championship live from Las Vegas'
  }
];
      ...
      <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 hidden md:flex items-center justify-center">
          {[-2, -1, 1, 2].map((offset) => {
            ...
            const index = (currentBanner + offset + liveBanners.length) % liveBanners.length;
            
            return liveBanners[index] && (
              <div
                key={offset}
              ...
              >
                <img
                  src={liveBanners[index].imageUrl}
                  alt=""
            ...
            <Link
              ...
              style={{
                ...
                transform: `rotateY(${
                  ...
                  index === ((currentBanner - direction + liveBanners.length) % liveBanners.length) ? '50deg' :
                  '-50deg'
                })`,

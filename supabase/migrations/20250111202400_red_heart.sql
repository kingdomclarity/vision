-- Create function to log access with explicit schema references
...
-- Create function to check system health with explicit schema references
...
-- Update increment_video_views function with explicit schema references
...
-- Update update_updated_at_column function with explicit schema references
...
-- Configure shorter OTP expiry for better security
ALTER TABLE auth.users 
  ALTER COLUMN otp_expires_at 
